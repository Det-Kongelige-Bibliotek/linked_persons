...
module LP
  module QueryMaker
    ...
    TARGET_DATA_PROPERTIES = [ 
      ...
      Vocab.wdt.P18,              # Image
      Vocab.wdt.P569,             # Date of birth
      Vocab.wdt.P570,             # Date of death
      Vocab.wdt.P742,             # Pseudonym
    ].freeze

    TARGET_OBJECT_PROPERTIES = [ 
      Vocab.wdt.P19,  # Place of birth
      Vocab.wdt.P20,  # Place of death
      Vocab.wdt.P21,  # Gender
      Vocab.wdt.P27,  # Country of citizenship
      Vocab.wdt.P103, # Native language
      Vocab.wdt.P106, # Occupation
      Vocab.wdt.P1412 # Used language
    ].freeze
    ...
    def make_patterns_for_d_properties(uri, where_patterns=false)
      TARGET_DATA_PROPERTIES.map.with_index do |property, index|
        ...
        # from matching.
        if where_patterns && property != Vocab.wdt.P18
