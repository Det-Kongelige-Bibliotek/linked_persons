  ...
  module Persistable
    ...
    def save
      unless redis.set(id, graph.to_ttl) && \
        ...
        raise Errors::CouldNotBeSaved, subject_uri
      end
    ...
    def fetch_from_db_or_dereference!
      raise Errors::AlreadyExists, subject_uri if exists?
      ...
      if saved?
        ...
        raise Errors::NotFound, subject_uri
      end
    ...
    def fetch_from_db
      ...
      raise Errors::NotFound, subject_uri unless content
